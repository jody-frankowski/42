...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/10 14:44:58 by jarcher           #+#    #+#             */
/*   Updated: 2020/06/27 01:52:37 by vveyrat-         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
/*
** ins_and() - and instruction
** @arena: The arena
** @process: The current process
**
** Does a binary AND between two direct, indirect or register values
...
int			ins_and(t_arena *arena, t_process *process)
{
	...
	process->registers[process->
		current_instruction.args[2] - 1] = value1 & value2;
	set_carry(process);
	return (EXIT_SUCCESS);
}
