...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/10 14:45:48 by jarcher           #+#    #+#             */
/*   Updated: 2020/06/27 01:51:41 by vveyrat-         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
/*
** ins_xor() - xor instruction
** @arena: The arena
** @process: The current process
**
** Does a binary XOR between two direct, indirect or register values
